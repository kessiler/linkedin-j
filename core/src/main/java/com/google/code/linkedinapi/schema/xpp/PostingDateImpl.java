...
public class PostingDateImpl
    extends BaseSchemaEntity implements PostingDate
{
	...
	public void toXml(XmlSerializer serializer) throws IOException {
		XmlSerializer element = serializer.startTag(null, "posting-date");
		...
		serializer.endTag(null, "posting-date");
	}
}
