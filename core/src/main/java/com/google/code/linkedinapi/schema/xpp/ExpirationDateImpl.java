...
public class ExpirationDateImpl
    extends BaseSchemaEntity implements ExpirationDate
{
	...
	public void toXml(XmlSerializer serializer) throws IOException {
		XmlSerializer element = serializer.startTag(null, "expiration-date");
		...
		serializer.endTag(null, "expiration-date");
	}
}
