...
public class CompanyStatusUpdateImpl
    extends BaseSchemaEntity implements CompanyStatusUpdate
{
	...
	public void toXml(XmlSerializer serializer) throws IOException {
		XmlSerializer element = serializer.startTag(null, "company-status-update");
		if (getShare() != null) {
			((ShareImpl) getShare()).toXml(serializer);
		}
		element.endTag(null, "company-status-update");;
	}
